...
export DEFAULT_SYS, DEFAULT_FES_SETTINGS, format_gainlose, fes_run
...
const DEFAULT_FES_SETTINGS = fes_settings()
...
function fes_run( systems::Vector )::Tuple
    ...
    summaries = nothing 
    rtime = @be begin
        results = do_one_run( DEFAULT_FES_SETTINGS, systems, run_progress )
