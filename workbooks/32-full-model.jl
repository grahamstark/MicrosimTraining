...
begin
using PlutoUI # bug ...
default_tax_allowance = 12_570.0
default_income_tax_rate = 20.0
default_uc_taper = 55.0
default_child_benefit = 25.60
default_pension = 221.20
...
md"""
## Taxes and Benefits
Tax Allowance: $(@bind tax_allowance PlutoUI.confirm(NumberField(0:10:25000,default=12_570))) (£p.a.; *default £12,570*)

Income Tax Rate: $(@bind income_tax_rate PlutoUI.confirm(NumberField(0:1:100,default=20))) (%; *default 20*)

Benefit Withdrawal Rate: $(@bind uc_taper PlutoUI.confirm(NumberField(0:1:100,default=55))) (%; *default 55*)

Child Benefit: $(@bind child_benefit PlutoUI.confirm(NumberField(0:0.01:100,default=25.60))) (£s pw; *default £25.60p*)

Pension: $(@bind pension PlutoUI.confirm(NumberField(0:0.01:500,default=221.20))) (£s pw; *default £221.20p*)
...
Net Cost of your changes: **$(res.netcost)**
