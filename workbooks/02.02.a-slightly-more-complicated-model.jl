...
using Downloads,DataFrames, CSV, Plots, Formatting
...
begin
	function tbsys( hh, allow, rate, ben )
...
begin
	p=plot(cumsum(ones(n))/n, cumsum(sort(net))/ninc,color=:red)
	plot!(p,[0,1],[0,1],color=:blue)
	p
end
...
manifest_format = "2.0"
project_hash = "7e6dd9754f77ba81c0e30fd16e6be09a34570f94"
